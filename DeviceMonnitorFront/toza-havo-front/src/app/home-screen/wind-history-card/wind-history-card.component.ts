...
@Component({
  selector: 'app-wind-history-card',
  templateUrl: './wind-history-card.component.html',
  styleUrls: ['./wind-history-card.component.css']
})
export class WindHistoryCardComponent {
  data = [
    [4.9, 246],
    [4.1, 242],
    [3.2, 262],
