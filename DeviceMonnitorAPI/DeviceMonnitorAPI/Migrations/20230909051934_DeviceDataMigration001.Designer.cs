...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20230909051934_DeviceDataMigration001")]
    partial class DeviceDataMigration001
    {
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("b63b72ae-98c6-4e0a-84c5-248cb8de7fc6"),
                            CreatedDate = new DateTime(2023, 9, 9, 10, 19, 34, 443, DateTimeKind.Local).AddTicks(790),
                        ...
                        new
                        {
                            UserGuid = new Guid("6dc25df5-bb5e-4bf3-9765-4eaac5cd3765"),
                            CreatedDate = new DateTime(2023, 9, 9, 10, 19, 34, 443, DateTimeKind.Local).AddTicks(7055),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
                        ...
                        new
                        {
                            UserGuid = new Guid("d7d7f72a-ee26-41eb-a181-83022c00d798"),
                            CreatedDate = new DateTime(2023, 9, 9, 10, 19, 34, 443, DateTimeKind.Local).AddTicks(7067),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Device",
                            IsActive = true,
                            LastName = "User",
