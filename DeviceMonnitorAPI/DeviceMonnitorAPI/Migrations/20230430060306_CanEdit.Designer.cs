...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20230430060306_CanEdit")]
    partial class CanEdit
    {
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("6c1f92c1-0fc3-4f37-912a-1a739c461293"),
                            CreatedDate = new DateTime(2023, 4, 30, 11, 3, 5, 876, DateTimeKind.Local).AddTicks(7438),
                        ...
                        new
                        {
                            UserGuid = new Guid("26c45cc7-b257-4f2e-b817-6454f5a7c1c1"),
                            CreatedDate = new DateTime(2023, 4, 30, 11, 3, 5, 877, DateTimeKind.Local).AddTicks(5270),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
